    ...
    return (
        ...
        <React.Fragment>
            <nav class="navbar  fluid-container navbar-light bg-secondary d-flex justify-content-end">
               <Link to="/login"><button type="button" class="btn btn-light mr-md-3" >Registro</button></Link>
                <Link to="/signup"> <button type="button" class="btn btn-light mr-md-3">Acceder</button></Link>
            </nav>
            <div>
