  ...
  User.create(user, (err, data) => {
    ...
    const place = [
      ...
      },
      {
        ...
        creator: "Aledia Ortega",
        creator_id: fakeUserID,
        creator_img:
          "https://smoda.elpais.com/wp-content/uploads/2017/08/40mujeres14-1-635x480.jpg",
        coords: [
          {
            latitude: 37.17492,
            longitude: -3.598484
      ...
      },
      {
        ...
        creator_id: fakeUserID,
        creator_img:
          "https://cdn2.salud180.com/sites/default/files/styles/medium/public/field/image/2016/07/beard1_0.jpg",
        coords: [
          {
            latitude: 37.17492,
            longitude: -3.598484
